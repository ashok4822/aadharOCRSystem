...
import { UploadCloud, AlertCircle, RefreshCw, Image as ImageIcon } from 'lucide-react';
...
interface UploadCardProps {
  ...
  loading: boolean;
  error: string | null;
  onFileChange: (e: React.ChangeEvent<HTMLInputElement>, type: 'front' | 'back') => void;
      ...
      <div className="glass-panel" style={{ padding: '1.75rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          <button
            ...
            style={{ background: 'rgba(31, 41, 55, 0.4)', color: '#f8fafc', border: '1px solid rgba(255, 255, 255, 0.08)', padding: '0.85rem 1.2rem', borderRadius: '8px', fontWeight: 600, cursor: 'pointer', opacity: (loading || (!frontPreview && !backPreview && !hasResult)) ? 0.5 : 1 }}
          >
            Reset
          </button>
        </div>
